...
htmlhelp_basename = 'WolvnetRezeptedoc'
...
latex_documents = [
    (master_doc, 'WolvnetRezepte.tex', 'Wolvnet Rezepte Documentation',
     'Daniel Jakob', 'manual'),
]
...
man_pages = [
    (master_doc, 'wolvnetrezepte', 'Wolvnet Rezepte Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WolvnetRezepte', 'Wolvnet Rezepte Documentation',
     author, 'WolvnetRezepte', 'One line description of project.',
     'Miscellaneous'),
]
...
ddidier_sphinxdoc_image_tag = 'bcdf8c8cf22efafb221b3b2fc2cfd925b362fea884816de5578c4e9b9d0286c8'
